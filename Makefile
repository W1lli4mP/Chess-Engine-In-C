...
$(TEST_MOVE_APPLY_TARGET): $(COMMON_OBJS) $(TEST_UTILS_OBJ) $(TEST_MOVE_APPLY_OBJ) | $(BIN_DIR)
	$(CC) $(CFLAGS) -o $(TEST_MOVE_APPLY_TARGET) $(COMMON_OBJS) $(TEST_UTILS_OBJ) $(TEST_MOVE_APPLY_OBJ)
